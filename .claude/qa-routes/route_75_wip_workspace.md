...
3. Edit Details; double-click and confirm Overview, Structure, Tasks, Files, References, and Activity.
...
7. Link/change/open/unlink a Library paper without copying or deleting its canonical record.
8. Visit every Synthesize/Discover/Work subtab. Confirm the WIP cue, click-through, and absence of a paper cue.
9. Remove/restore a folder and confirm stable UUID, metadata, workflow, and links reconnect.
