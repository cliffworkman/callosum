<!-- qa-coverage
api: /settings, /settings/providers, /settings/providers/{pid}, /settings/test-key, /settings/access-token, /access/recover, /integrations/libreoffice/*, /integrations/word/*
