<!-- qa-coverage
api: /settings, /settings/providers, /settings/providers/{pid}, /settings/test-key, /settings/repair-summary-cache, /settings/access-token, /access/recover, /integrations/libreoffice/*, /integrations/word/*
fe: 35_settings.jsx, 35b_providers.jsx, 01_recovery.jsx
-->
