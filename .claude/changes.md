...
<!-- HELP-DOCS-SYNCED 2026-06-30 inc 217 — new "Filling in missing metadata (gap-fill enrichment)" section (per-paper Fill missing fields + library-wide Enrich metadata ↻; fills only blanks, DOI recovery, public-metadata-not-Gemini-gate) -->
