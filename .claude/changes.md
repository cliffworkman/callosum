...
<!-- HELP-DOCS-SYNCED 2026-07-16 — corpus current through inc 279 (new "Finding work the field overlooked" section). Incs 272–278 were backend concurrency (no user-facing help surface); inc 271 (#12 set critical review) help is tracked separately. -->
