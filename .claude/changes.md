...
<!-- HELP-DOCS-SYNCED 2026-07-02 inc 254 — Remote-access help gained the in-app lockout-recovery path (paste the token, or the local-file-code reset that turns Remote access off); replaced the stale "remove the token from app-settings.json" advice -->
