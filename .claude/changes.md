...
<!-- HELP-DOCS-SYNCED 2026-07-03 inc 255 — "Extract workspace" help gained the select-in-PDF value capture (verbatim + editable value + an exact-coordinate anchor) and the exact-vs-region Open-at-anchor distinction -->
