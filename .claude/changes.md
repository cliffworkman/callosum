...
<!-- HELP-DOCS-SYNCED 2026-06-30 inc 229 — help renamed to "Checking citation concentration"; geography/gender language removed; covers the ⚠ low-coverage flag -->
## 2026-06-30 — Increment 229: Citation equity → "Citation concentration" — drop the people-categorizing geography signal + gender framing (rejected on principle), rename; + low-coverage flag
