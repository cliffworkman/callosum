...
<!-- HELP-DOCS-SYNCED 2026-06-30 inc 216 — "Using Callosum from an AI agent (MCP)" now covers the opt-in write tools (add tag / add-to-axis / save-reference / annotate), the reversible audit log, and the default-off + kill-switch posture -->
