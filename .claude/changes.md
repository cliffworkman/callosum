...
- **Why:** Cliff's "precise highlighting" ask. The machinery was already built end-to-end (and Codex extended exact anchoring across the Methods pane in PR #5); the gap was the locator's hit-rate. This locator fix lifts summary citations now and every Methods evidence surface once PR #5 lands.
