...
It is currently at **Increment 324** (see Increment workflow) with **1323 pytest tests
...
callosum is built in **numbered increments** (currently at 324). Each increment of real work
