...
It is currently at **Increment 243** (see Increment workflow) with **904 pytest tests
...
│   │   ├── methods/               (statcheck.py [NHST p-value recomputation, inc 95], pcurve.py [inc 126], grim.py
   ...
   │   │                          bayes.py [Bayesian auditor: recompute default JZS t-test Bayes factors, inc 241; + a Tier-2 BARG/WAMBS/JASP completeness checklist, inc 242; + Ly-2016 Pearson-correlation BFs, inc 243])
...
*Last updated: 2026-07-01 — increment 243 (Bayesian auditor SP3 — the **Pearson-correlation recompute** [Ly et al.
