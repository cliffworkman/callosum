...
It is currently at **Increment 335** (see Increment workflow) with **1360 pytest tests
...
callosum is built in **numbered increments** (currently at 335). Each increment of real work
