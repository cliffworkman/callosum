...
It is currently at **Increment 339** (see Increment workflow) with **1383 pytest tests
...
callosum is built in **numbered increments** (currently at 339). Each increment of real work
