...
It is currently at **Increment 326** (see Increment workflow) with **1323 pytest tests
...
callosum is built in **numbered increments** (currently at 326). Each increment of real work
