...
It is currently at **Increment 313** (see Increment workflow) with **1292 pytest tests
...
callosum is built in **numbered increments** (currently at 313). Each increment of real work
