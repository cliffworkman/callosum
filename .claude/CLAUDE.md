...
It is currently at **Increment 320** (see Increment workflow) with **1315 pytest tests
...
callosum is built in **numbered increments** (currently at 320). Each increment of real work
