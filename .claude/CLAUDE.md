...
It is currently at **Increment 282** (see Increment workflow) with **1237 pytest tests
...
callosum is built in **numbered increments** (currently at 282). Each increment of real work
