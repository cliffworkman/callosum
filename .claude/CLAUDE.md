...
It is currently at **Increment 251** (see Increment workflow) with **971 pytest tests
...
│   │   │                          file-serving, inc 91],methods [statcheck, inc 95],citation_equity [citation-concentration: structural reference-list audit, inc 227; geography signal removed inc 229],citation_context [scite-analogue "how this paper is cited" — Semantic Scholar contexts + local NLI stance, inc 232],citations [formatted-citation
...
*Last updated: 2026-07-02 — increment 251 (**persist transparency signals** — backlog #44 increment 1b: turns the
