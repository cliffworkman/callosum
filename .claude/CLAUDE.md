...
It is currently at **Increment 337** (see Increment workflow) with **1374 pytest tests
...
callosum is built in **numbered increments** (currently at 337). Each increment of real work
