...
It is currently at **Increment 293** (see Increment workflow) with **1247 pytest tests
...
callosum is built in **numbered increments** (currently at 283). Each increment of real work
