...
It is currently at **Increment 242** (see Increment workflow) with **899 pytest tests
...
│   │   ├── methods/               (statcheck.py [NHST p-value recomputation, inc 95], pcurve.py [inc 126], grim.py
   ...
   │   │                          bayes.py [Bayesian auditor: recompute default JZS Bayes factors, inc 241; + a Tier-2 BARG/WAMBS/JASP completeness checklist, inc 242])
...
*Last updated: 2026-07-01 — increment 242 (Bayesian auditor SP2 — a Tier-2 **BARG/WAMBS/JASP reporting checklist**;
