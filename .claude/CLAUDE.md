...
It is currently at **Increment 306** (see Increment workflow) with **1280 pytest tests
...
callosum is built in **numbered increments** (currently at 306). Each increment of real work
