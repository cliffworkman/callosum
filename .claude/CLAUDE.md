...
It is currently at **Increment 266** (see Increment workflow) with **1077 pytest tests
...
callosum is built in **numbered increments** (currently at 261). Each increment of real work
