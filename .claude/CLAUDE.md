...
It is currently at **Increment 241** (see Increment workflow) with **894 pytest tests
...
│   │   ├── methods/               (statcheck.py [NHST p-value recomputation, inc 95], pcurve.py [inc 126], grim.py
   ...
   │   │                          bayes.py [Bayesian auditor: recompute default JZS Bayes factors for inline t-test BFs, inc 241])
...
*Last updated: 2026-07-01 — increment 241 (Bayesian auditor SP1 — recompute default **JZS Bayes factors**, the
