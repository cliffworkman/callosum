...
It is currently at **Increment 321** (see Increment workflow) with **1316 pytest tests
...
callosum is built in **numbered increments** (currently at 321). Each increment of real work
