...
It is currently at **Increment 280** (see Increment workflow) with **1236 pytest tests
...
callosum is built in **numbered increments** (currently at 280). Each increment of real work
