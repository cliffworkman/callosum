...
It is currently at **Increment 398** (see Increment workflow) with **1642 pytest tests
...
callosum is built in **numbered increments** (currently at 398). Each increment of real work
