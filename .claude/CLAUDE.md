...
It is currently at **Increment 314** (see Increment workflow) with **1294 pytest tests
...
callosum is built in **numbered increments** (currently at 314). Each increment of real work
