...
It is currently at **Increment 334** (see Increment workflow) with **1354 pytest tests
...
callosum is built in **numbered increments** (currently at 334). Each increment of real work
