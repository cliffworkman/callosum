...
It is currently at **Increment 322** (see Increment workflow) with **1322 pytest tests
...
callosum is built in **numbered increments** (currently at 322). Each increment of real work
