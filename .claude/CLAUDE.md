...
It is currently at **Increment 302** (see Increment workflow) with **1264 pytest tests
...
callosum is built in **numbered increments** (currently at 302). Each increment of real work
