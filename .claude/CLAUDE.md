...
It is currently at **Increment 316** (see Increment workflow) with **1302 pytest tests
...
callosum is built in **numbered increments** (currently at 316). Each increment of real work
