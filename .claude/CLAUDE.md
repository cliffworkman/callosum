...
It is currently at **Increment 250** (see Increment workflow) with **963 pytest tests
...
│   │   │                          annotations,tags,axes,summaries,findings [FACT/CANDIDATE store, inc 130],
   ...
   │                          transparency [transparency-signals auditor: open-science-disclosure detectors, #44, inc 250],
...
*Last updated: 2026-07-02 — increment 250 (**transparency-signals auditor** — backlog #44 increment 1, the Lakens
