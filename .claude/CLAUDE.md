...
It is currently at **Increment 338** (see Increment workflow) with **1380 pytest tests
...
callosum is built in **numbered increments** (currently at 338). Each increment of real work
