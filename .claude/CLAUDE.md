...
It is currently at **Increment 346** (see Increment workflow) with **1414 pytest tests
...
callosum is built in **numbered increments** (currently at 346). Each increment of real work
