...
It is currently at **Increment 279** (see Increment workflow) with **1235 pytest tests
...
callosum is built in **numbered increments** (currently at 279). Each increment of real work
