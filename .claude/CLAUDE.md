...
It is currently at **Increment 329** (see Increment workflow) with **1333 pytest tests
...
callosum is built in **numbered increments** (currently at 329). Each increment of real work
