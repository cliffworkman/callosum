...
It is currently at **Increment 276** (see Increment workflow) with **1223 pytest tests
...
callosum is built in **numbered increments** (currently at 271). Each increment of real work
