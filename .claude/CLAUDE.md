...
It is currently at **Increment 348** (see Increment workflow) with **1418 pytest tests
...
callosum is built in **numbered increments** (currently at 347). Each increment of real work
