...
It is currently at **Increment 217** (see Increment workflow) with **774 pytest tests
...
│   │   │                          enrich_sources.py [pluggable enrichment-source registry: Crossref/OpenAlex; SP2 +EuropePMC/PubMed, inc 217],
...
*Last updated: 2026-06-30 — increment 217 (multi-pass, gap-filling metadata enrichment — SP1; beta feedback from
