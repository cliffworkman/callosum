...
It is currently at **Increment 340** (see Increment workflow) with **1388 pytest tests
...
callosum is built in **numbered increments** (currently at 340). Each increment of real work
