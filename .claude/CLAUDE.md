...
It is currently at **Increment 341** (see Increment workflow) with **1396 pytest tests
...
callosum is built in **numbered increments** (currently at 341). Each increment of real work
