...
It is currently at **Increment 304** (see Increment workflow) with **1265 pytest tests
...
callosum is built in **numbered increments** (currently at 304). Each increment of real work
