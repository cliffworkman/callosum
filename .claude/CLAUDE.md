...
It is currently at **Increment 424** (see Increment workflow) with **1713 pytest tests
...
callosum is built in **numbered increments** (currently at 424). Each increment of real work
