...
It is currently at **Increment 331** (see Increment workflow) with **1340 pytest tests
...
callosum is built in **numbered increments** (currently at 331). Each increment of real work
