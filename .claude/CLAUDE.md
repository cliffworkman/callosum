...
It is currently at **Increment 305** (see Increment workflow) with **1265 pytest tests
...
callosum is built in **numbered increments** (currently at 305). Each increment of real work
