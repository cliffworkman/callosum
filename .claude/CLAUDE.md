...
│   │   ├── discovery/             (providers.py [SourceProvider registry + normalized Item + cross-provider dedup],
   ...
   │   │                          metadata-only save]; backlog #28 Search, inc 183)
