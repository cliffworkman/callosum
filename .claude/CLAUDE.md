...
It is currently at **Increment 317** (see Increment workflow) with **1303 pytest tests
...
callosum is built in **numbered increments** (currently at 317). Each increment of real work
