...
It is currently at **Increment 336** (see Increment workflow) with **1368 pytest tests
...
callosum is built in **numbered increments** (currently at 336). Each increment of real work
