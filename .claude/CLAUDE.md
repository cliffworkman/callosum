...
It is currently at **Increment 319** (see Increment workflow) with **1310 pytest tests
...
callosum is built in **numbered increments** (currently at 319). Each increment of real work
