...
It is currently at **Increment 303** (see Increment workflow) with **1264 pytest tests
...
callosum is built in **numbered increments** (currently at 303). Each increment of real work
