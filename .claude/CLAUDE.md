...
It is currently at **Increment 281** (see Increment workflow) with **1237 pytest tests
...
callosum is built in **numbered increments** (currently at 281). Each increment of real work
