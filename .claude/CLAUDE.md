...
It is currently at **Increment 239** (see Increment workflow) with **884 pytest tests
...
│                                  pinch-to-zoom [30f_pdf_gestures.jsx] + a citation "← Synthesis" back pill). The
│                                  read-only *guarantee* = the CALLOSUM_READ_ONLY method gate.
...
*Last updated: 2026-07-01 — increment 239 (B5 SP3 — **the mobile PDF reader** — the deferred B5 slice; brainstormed →
