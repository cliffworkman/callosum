...
It is currently at **Increment 318** (see Increment workflow) with **1304 pytest tests
...
callosum is built in **numbered increments** (currently at 318). Each increment of real work
