...
It is currently at **Increment 397** (see Increment workflow) with **1636 pytest tests
...
callosum is built in **numbered increments** (currently at 397). Each increment of real work
