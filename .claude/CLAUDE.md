...
It is currently at **Increment 323** (see Increment workflow) with **1322 pytest tests
...
callosum is built in **numbered increments** (currently at 323). Each increment of real work
