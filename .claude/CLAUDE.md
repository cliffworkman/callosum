...
It is currently at **Increment 307** (see Increment workflow) with **1283 pytest tests
...
callosum is built in **numbered increments** (currently at 307). Each increment of real work
