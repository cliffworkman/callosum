...
function useLibrary(opts) {
  ...
  // inc-62 → inc 286: "summarize N" → drive the Synthesis workspace to summarize the selected subset.
  ...
  // inc 117 (SP1) → inc 286: summarize an explicit id set (from the My Publications tab) → drive Synthesis.
