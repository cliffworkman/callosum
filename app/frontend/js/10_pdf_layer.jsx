...
function PaperList({ state, query, onQuery, selected, onSelect, page, onPage, total, onOpenPdf,
                    ...
                    openDataDetected, onShowTransparencyReview, lmmFlagged, onShowLmmFlagged, metaFlagged, onShowMetaFlagged,
      ...
      <div className="pane-head">
        <div className="lib-head">
          ...
          {!readOnly && <span className="lib-head-actions">
            ...
            {(showStatcheckChip || showRetractionChip || showTransparencyChip || showLmmChip || showMetaChip) &&
