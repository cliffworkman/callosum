...
function FeedSuggestModal({ subs, libJournals, sourceMeta, onFollow, onFollowAuthor, onClose }) {
    ...
    <div className="axis-modal-overlay" onClick={onClose}>
      <div className="axis-modal feed-suggest-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="feed-suggest-body">
          ...
          {tab === "author" && <FeedSuggestAuthors authors={authorSuggestions} onFollow={onFollowAuthor} />}
        </div>
      </div>
    </div>
  );
            ...
            return (
              <div key={a.name} className="gap-row">
                <div className="gap-row-info">
                  ...
                  <div className="gap-row-meta"><span className="gap-count">{a.paper_count} paper{a.paper_count === 1 ? "" : "s"} in your library</span></div>
                </div>
                <div className="gap-row-actions">
                  {isFollowed
                    ? <span className="discover-inlib">✓ Following</span>
