...
- **Citation style…** — pick a CSL style (apa, ieee, nature, …) and locale; the whole document re-renders. Chicago notes and bibliography renders new citations in native Writer notes, including first/subsequent-note context.
